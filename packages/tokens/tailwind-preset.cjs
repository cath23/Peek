/**
 * Shared Tailwind preset for all Nostr-for-Business apps.
 * Brand-agnostic: every color maps to a CSS variable, so a brand theme only has to
 * redefine the variable values (see base.css + themes/*.css). Apps extend this via
  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        // accent (brand — value swapped per theme)
